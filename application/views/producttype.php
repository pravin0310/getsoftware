<section id="main-content" >
    <section class="wrapper">
      ...
      <div class="panel-heading">
        <div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> <b>Product Type Details</b></div>
      </div> <!-- /panel-heading -->
      ...
      <div class="panel-body"  >
        ...
        <div class="col-md-4">
        <div class="panel-heading" >
        <button class="btn btn-primary " data-toggle="modal" id="addServiceModalBtn" data-target="#add_data_Modal" style="width:200px" > Add Product</button>
        </div>
        </div>
      ...
      <div class="modal-content">
       ...
       <form method="post" id="edit_form">  
         <div id="add-product-messages"></div>
                          ...
                          <input type="submit" name="insert" id="Update" value="Insert" class="btn btn-success" />  
                     </form>  
        </div>
...
<!-- End Edit modal -->
 ...
 $(document).ready(function(){  
      ...
      $(document).on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url("producttype/user_data/") ?>",  
                method:"POST",  
                data:{id:id},  
                dataType:"json",  
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url() ?>producttype/add",  
                     method:"POST",  
          ...
          $('#edit_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url() ?>producttype/update",  
                     method:"POST",  
