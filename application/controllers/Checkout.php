...
class Checkout extends CI_Controller { 
    ...
    public function index(){ 
        ...
        $data['value']=$this->load->library('cart'); 
    ...
    function purchase($id){ 
        ...
        $product = $this->checkout_model->getRows($id); 
    ...
    function payment($postData){ 
        ...
        if(!empty($postData)){ 
            ...
            if($customer){ 
                ...
                $charge = $this->stripe_lib->createCharge($customer->id, $postData['product']['name'], $postData['product']['amount']); 
